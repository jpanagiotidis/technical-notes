...
var ABOUT_RESOURCES = [
      ...
      }, 
      {
        "title":"Android Auto",
        "titleFriendly":"",
        "summary":"Let drivers listen to and control content in your music and other audio apps. Allow drivers to hear and respond to your messaging service via the car&#39;s controls and screen. Before you start building, check out the Introduction to Android Auto video…",
        "url":"auto/index.html",
        "group":"",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "image":"//chart.googleapis.com/chart?chl=GL%202.0%7CGL%203.0&chd=t%3A74.7%2C25.3&chf=bg%2Cs%2C00000000&chco=c4df9b%2C6fad0c&cht=p&chs=400x250",
        "lang":"en",
        "type":"about"
      }
];
...
var DESIGN_RESOURCES = [
      ...
      }, 
      {
        "title":"Notifications",
        "titleFriendly":"",
        "summary":"Notifying the User The notification system allows users to keep informed about relevant and timely events in your app, such as new chat messages from a friend or a calendar event. Think of notifications as a news channel that alerts the user to important…",
...
var SAMPLES_RESOURCES = [
      ...
      }, 
      {
        "title":"SpeedTracker",
        "titleFriendly":"",
        "summary":"This sample uses the FusedLocation APIs of GMS on those devices that have a hardware GPS built in. In those cases, this sample provides a simple screen that shows the current speed of the device on the watch. User can set a speed limit and if the speed…",
      ...
      }, 
      {
        "title":"DataLayer",
        "titleFriendly":"",
        "summary":"You can cause the wearable to start an activity by pressing a button in the companion app UI. You can also take a picture on the companion device, which will be transmitted as an Asset for display on the wearable.…",
      ...
      }, 
      {
        "title":"RecyclerView",
        "titleFriendly":"",
        "summary":"Demonstration of using RecyclerView with a LayoutManager to create a vertical ListView.…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"Demonstrates how to the use Activity scene transitions when transitions from one Activity to another. Uses a combination of moveImage and changeBounds to nicely transition a grid of images to an Activity with a large image and detail text.…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"This sample shows how to implement an audio media app that provides media library metadata and playback controls through a standard service.…",
      ...
      }, 
      {
        "title":"What&#39;s New",
        "titleFriendly":"",
        "summary":"The following code samples were recently published for the L Developer Preview. You can download them in the Android SDK Manager under the SDK Samples component for the L Developer Preview. This sample is a simple audio media app that exposes its media…",
...
var TOOLS_RESOURCES = [
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"If you&#39;ve previously developed for Android using Eclipse and would like to migrate to Android Studio, you can import your project into Android Studio. Now that your project is imported to Android Studio, read Tips and Tricks for some help getting …",
...
var TRAINING_RESOURCES = [
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["nowplaying","mediasession"],
        "tags": ["nowplaying","mediasession"],
        "image":"",
        "lang":"en",
        "type":"training"
      }, 
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["wear","notifications","wearables"],
        "tags": ["wear","notifications","wearables"],
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["wear","wearable","app"],
        "tags": ["wear","wearable","app"],
...
var DESIGN_BY_TAG = {
    ...
    "support":[7], 
    "viewpager":[8,34], 
    "navigation":[8,10,13,14,16,18,20,34], 
    "tabs":[8,34], 
    "dialog":[9,38,58], 
    "toast":[9,38,58], 
    "notification":[9,58], 
...
var DISTRIBUTE_BY_TAG = {
    "landing":[1,32], 
    "quality":[1,13,20,32,39], 
    "gpfe":[12], 
    "googleplay":[12,45,55,56,63,65,66,67], 
    "distribution":[12], 
    "edu":[12], 
    "education":[13,14], 
    "guidelines":[13,39], 
    "visibility":[16], 
    "growth":[16,58,59,61,62,63], 
    "distributing":[16], 
    "distribute":[17], 
    "bestpractices":[17], 
    "publishing":[19,50,51], 
...
var GUIDE_BY_TAG = {
    ...
    "wav":[7], 
    "multiplescreens":[15], 
    "searchrecentsuggestionsprovider":[22,23], 
    "searchrecentsuggestions":[23], 
    "searchview":[24], 
    "sdcard":[26,28], 
    "external":[26], 
    "database":[28], 
    ...
    "spinneradapter":[80], 
    "edittext":[82], 
    "autocompletetextview":[82], 
    "alertdialog":[87], 
    "dialogfragment":[87], 
    "home":[89], 
    "appwidgetprovider":[89], 
    "appwidgethost":[90], 
    "homescreen":[90], 
    "launcher":[90], 
    "sipmanager":[92], 
    ...
    "telephony":[92], 
    "wireless":[93,101,102], 
    "bluetoothadapter":[93,101], 
    "bluetoothdevice":[93,101], 
    "ble":[93], 
    "btle":[93], 
    "hostcardemulation":[100], 
    "hce":[100], 
    "hostapduservice":[100], 
    "offhostapduservice":[100], 
    "tapandpay":[100], 
    "mediarouter":[113], 
    "cast":[113], 
    "chromecast":[113], 
    "wirelessdisplay":[113], 
    "miracast":[113], 
    "mediarecorder":[114,116], 
    "mediarouteprovider":[115], 
    "mediacontrolintent":[115], 
    "photo":[116], 
    "mediaplayer":[118], 
    "soundpool":[118], 
    "audiomanager":[118], 
    "input":[120,121], 
    "spellcheckerservice":[120], 
    "clipboardmanager":[121], 
    "ime":[122], 
    "keyboard":[122], 
    "inputmethodservice":[122], 
    "location":[123], 
    "sensors":[123], 
    "sensorevent":[124,127], 
    "orientation":[124], 
    ...
    "sdkversion":[138], 
    "minsdkversion":[138], 
    "targetsdkversion":[138], 
    "maxsdkversion":[138], 
    "filtering":[142], 
    "features":[142], 
    "googleplayfilters":[142], 
    "permissions":[142], 
    "devicepolicymanager":[156], 
    "policy":[156], 
    "security":[156], 
    "recents":[160], 
    "overview":[160], 
    "intentfilter":[164,167]
};

var SAMPLES_BY_TAG = {
    "swiperefreshmultipleviews":[0], 
    "clippingbasic":[1], 
    "drawabletinting":[2], 
    "customchoicelist":[3], 
    "cardemulation":[4], 
    "messagingservice":[5], 
    "basicgesturedetect":[6], 
    "notifications":[7], 
    "swiperefreshlistfragment":[8], 
    "customnotifications":[9], 
    ...
    "speedtracker":[14], 
    "camera2basic":[15], 
    "lnotificationssample":[16], 
    "renderscriptintrinsic":[17], 
    "basicimmersivemode":[18], 
    "findmyphone":[19], 
    "basicmediarouter":[20], 
    "datalayer":[21], 
    "apprestrictions":[22], 
    "cardreader":[23], 
    "fragmenttransition":[24], 
    "elizachat":[25], 
    "activityinstrumentation":[26], 
    "donebar":[27], 
    "customtransition":[28], 
    "timer":[29], 
    "basicnotifications":[30], 
    "batchstepsensor":[31], 
    "basicaccessibility":[32], 
    "gridviewpager":[33], 
    "actionbarcompat-listpopupmenu":[34], 
    "elevationdrag":[35], 
    ...
    "pdfrendererbasic":[39], 
    "mediaeffects":[40], 
    "revealeffectbasic":[41], 
    "apprestrictionschema":[42], 
    "jumpingjack":[43], 
    "basicmediadecoder":[44], 
    "bluetoothchat":[45], 
    "geofencing":[46], 
    "mycloud":[47], 
    "recyclerview":[48], 
    "basicrenderscript":[49], 
    "actionbarcompat-styled":[50], 
    "textswitcher":[51], 
    "displayingbitmaps":[52], 
    "embeddedapp":[53], 
    "slidingtabscolors":[54], 
    "repeatingalarm":[55], 
    "swiperefreshlayoutbasic":[56], 
    ...
    "basicnetworking":[61], 
    "navigationdrawer":[62], 
    "apprestrictionenforcer":[63], 
    "actionbarcompat-basic":[64], 
    "bluetoothlegatt":[65], 
    "synchronizednotifications":[66], 
    "hdrviewfinder":[67], 
    "basicmultitouch":[68], 
    "quiz":[69], 
    "actionbarcompat-shareactionprovider":[70], 
    "floatingactionbuttonbasic":[71], 
    "cardviewsample":[72], 
    "camera2video":[73], 
    "mediabrowserservice":[74], 
    "storageclient":[75], 
    "delayedconfirmation":[76], 
    "advancedimmersivemode":[77], 
    "documentcentricrelinquishidentity":[78], 
    "immersivemode":[79], 
    "elevationbasic":[80], 
    "adaptertransition":[81], 
    "recipeassistant":[82], 
    "jobscheduler":[83], 
    "documentcentricrecents":[84], 
    "slidingtabsbasic":[85], 
    "skeletonwearableapp":[86], 
    "basicandroidkeystore":[87], 
    "mediarecorder":[88], 
    "textlinkify":[89], 
    "basictransition":[90], 
    "basicmanagedprofile":[91], 
    "examples":[92], 
    "code":[92]
};
...
var TRAINING_BY_TAG = {
    ...
    "support":[50,265,345], 
    "print":[55], 
    "navigation":[55,89,110,154], 
    "gesturedetector":[55,89], 
    "scroller":[55,89], 
    "auto":[60,61,62], 
    "car":[60,61,62], 
    "automotive":[60,61,62], 
    "network":[64,144,182,187,242,306], 
    "internet":[64], 
    "camera":[69], 
    "video":[69], 
    "picture":[69], 
    ...
    "cloud":[109,269], 
    "":[113], 
    "tv":[125,126,131,135,136,265], 
    "tif":[125], 
    "focus":[127], 
    "selection":[127], 
    "d-pad":[127], 
    "leanback":[128,131,136,137], 
    "recyclerview":[128], 
    "launcher":[128], 
    "unsupported":[129], 
    "nowplaying":[132], 
    ...
    "geofence":[278], 
    "geofencing":[278], 
    "activityrecognition":[278], 
    "activitydetection":[278], 
    "appindexing":[286], 
    "intents":[294,295,296,297,321,330], 
    "layouts":[298,299], 
    "resources":[298,300], 
    "screens":[298], 
    "localization":[298,300], 
    "strings":[300], 
    "localizing":[300], 
    "styles":[301], 
    "datastorage":[302], 
    ...
    "emulator":[323], 
    "projectsetup":[324], 
    "activitylifecycle":[325,326,327,328,329], 
    "bitmaps":[335], 
    "images":[335], 
    "audio":[341], 
    "media":[341]
